    ...
    SLAM_(SLAM)
{
    ...
    subImgLeft_ = this->create_subscription<ImageMsg>("cam0/image_quantized", 100, std::bind(&StereoInertialNode::GrabImageLeft, this, _1));
    subImgRight_ = this->create_subscription<ImageMsg>("cam1/image_quantized", 100, std::bind(&StereoInertialNode::GrabImageRight, this, _1));
